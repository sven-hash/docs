...
It can be compiled by completing the 'Building your validator' step outlined in the [Validator](/docs/next/run-nym-nodes/nodes/validators) documentation. 
...
The guide to setting up an RPC node can be found [here](/docs/next/run-nym-nodes/nodes/rpc-node). 
