...
**DAO** - Stands for Decentralised Autonomous Organisation. It's a type of organisation that is ran through the use of smart contracts on a blockchain. Also it's a digital platform that operates on a set if rules encoded in a computer program, and is governed by the people who use it, rather than by a central authority.
