...
```
curl -d '{"since":"2022-08-10T12:46:00.000000+00:00", "until":"2022-08-13T12:57:00.000000+00:00"}' -H "Content-Type: application/json" -X POST https://mainnet-stats.nymte.ch:8090/v1/all-statistics
```
